                ...
                <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center min-h-[88vh]">
                    ...
                    <div>
                        ...
                        <p className="mt-6 text-slate-300 text-base sm:text-lg md:text-xl max-w-xl leading-relaxed">
                            TalentFlow AI analyzes your resume, builds your professional
                            profile, and recommends the best matching jobs using advanced AI.
                        </p>

                        <div className="mt-8 flex flex-col sm:flex-row gap-4">
                            <Link
                                to="/signup"
                                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-cyan-500 text-slate-950 font-bold hover:bg-cyan-400 transition"
                            >
                            ...
                            <Link
                                to="/login"
                                className="inline-flex items-center justify-center px-8 py-4 rounded-2xl border border-slate-700 text-slate-200 hover:border-cyan-400 hover:text-cyan-300 transition"
                            >
                                Login
                            </Link>
                        </div>
            ...
            <section className="px-5 py-12">
                <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
                    {stats.map(([number, label]) => (
                        <div
                            key={label}
                            className="rounded-3xl bg-slate-900/70 border border-slate-800 p-6 text-center"
                        >
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-14">
                        ...
                        <p className="text-slate-400 mt-4 max-w-2xl mx-auto">
                            TalentFlow AI combines AI analysis, profile building, and job
                            recommendations into one intelligent ecosystem.
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {features.map(({ icon: Icon, title, text }) => (
                            <div
                                key={title}
                                className="rounded-3xl bg-slate-900/70 border border-slate-800 p-6 hover:border-cyan-400/40 transition"
                            >
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-4 gap-5">
                        {steps.map((step, index) => (
                            <div
                                key={step}
                                className="rounded-3xl bg-slate-950 border border-slate-800 p-6"
                            >
            ...
            <section className="px-5 py-20">
                <div className="max-w-5xl mx-auto text-center rounded-[2rem] border border-slate-800 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 p-8 md:p-14">
                    ...
                    <p className="text-slate-300 mt-5 max-w-2xl mx-auto leading-relaxed">
                        Join TalentFlow AI today and transform your resume into real career
                        growth with AI-powered recommendations.
                    </p>

                    <Link
                        to="/signup"
                        className="mt-8 inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-cyan-500 text-slate-950 font-bold hover:bg-cyan-400 transition"
                    >
