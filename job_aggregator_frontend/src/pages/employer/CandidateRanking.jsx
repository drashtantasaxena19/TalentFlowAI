                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base">
                                        ...
                                        Discover top AI-ranked applicants based on skills,
                                        resume quality, profile strength,
                                        and job match score.
                            ...
                            {[
                                ...
                                ([
                                    ...
                                    <button
                                        ...
                                        className={`rounded-2xl border px-4 py-2 text-sm font-bold transition ${scoreFilter ===
                                                value
                            ...
                            {filteredCandidates.map(
                                (
                                    ...
                                    <CandidateRankingCard
                                        key={
                                            candidate._id ||
                                            `${candidate.email}-${candidate.jobId}`
                                        }
                                        candidate={
                                            candidate
                                        }
