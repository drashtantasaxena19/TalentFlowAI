...
import { saveCompanyProfile } from "../../services/employerApi";
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base">
                                        ...
                                        Build a trusted company identity
                                        for candidates and improve
                                        profile completion.
                    ...
                    {loading ? (
                        ...
                        >
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="rounded-2xl border border-slate-700/80 bg-slate-950/90 p-4 focus-within:border-orange-400/80">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full resize-none bg-transparent outline-none text-white placeholder:text-slate-500"
                                    />
                            ...
                            <div className="md:col-span-2 pt-2">
                                ...
                                <button
                                    type="submit"
                                    disabled={saving}
                                    className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-400 via-cyan-400 to-blue-500 px-6 py-4 font-black text-slate-950 transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60"
                                >
