...
export default function Applicants() {
    ...
    const filteredApplicants = useMemo(() => {
        ...
        return applicants.filter((applicant) => {
            ...
            return matchesScore && (q ? haystack.includes(q) : true);
        });
    }, [applicants, search, matchFilter]);
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base">
                                        Track real applicants, AI match scores, skill gaps, strengths,
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            {filteredApplicants.map((applicant) => (
                                <ApplicantCard
                                    key={applicant._id || `${applicant.email}-${applicant.jobId}`}
                                    applicant={applicant}
                                    onStatusUpdated={() => loadApplicants(true)}
                                />
                            ))}
                        </div>
                    )}
