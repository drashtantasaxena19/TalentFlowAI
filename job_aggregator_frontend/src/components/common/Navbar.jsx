...
export default function Navbar() {
    ...
    const currentTheme =
        roleTheme[role] || roleTheme.guest;

    return (
        <nav
            className={`fixed top-0 left-0 z-50 w-full border-b backdrop-blur-2xl bg-slate-950/80 ${currentTheme.border}`}
        >
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="h-16 md:h-20 flex items-center justify-between">
                    ...
                    >
                        <div
                            className={`relative rounded-2xl bg-gradient-to-br ${currentTheme.glow} p-1 transition-all duration-300 group-hover:scale-105`}
                        >
                            <img
                    ...
                    <div className="hidden md:flex items-center gap-5">
                        {!isAuthenticated ? (
                            <>
                                ...
                                <Link
                                    to="/signup"
                                    className={`px-5 py-2.5 rounded-2xl font-semibold transition-all duration-300 shadow-lg ${currentTheme.button}`}
                                >
                                    Get Started
                                </Link>
                            </>
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    className="px-5 py-2.5 rounded-2xl bg-red-500 hover:bg-red-400 text-white font-semibold transition-all duration-300"
                                >
                                    Logout
                                </button>
                            </>
                        ...
                        {!isAuthenticated ? (
                            <>
                                <Link
                                    ...
                                    className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-slate-900 text-slate-200"
                                >
                                    <Home size={18} />
                                    Home
                                </Link>
                                ...
                                <Link
                                    ...
                                    className={`flex items-center justify-center gap-2 px-4 py-3 rounded-2xl font-semibold ${currentTheme.button}`}
                                >
                                    <UserPlus size={18} />
                                    Get Started
                                </Link>
                            ...
                            <>
                                ...
                                <button
                                    onClick={handleLogout}
                                    className="flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-red-500 hover:bg-red-400 text-white font-semibold transition"
                                >
                                    <LogOut size={18} />
                                    Logout
                                </button>
