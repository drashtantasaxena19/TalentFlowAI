...
from src.api.applications_routes import router as application_router
from src.api.jd_parser_routes import jd_parser_router
from src.api.public_jobs_routes import router as public_jobs_router
